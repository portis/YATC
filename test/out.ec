...
let
   ...
   condition_de_E_de_obs_1_vers_E_de_obs_1_1=if (E_de_obs_1) then (1) else false;
   ...
   gnt1=if (I_de_M1_0) then false else if (W_de_M1_0) then false else if (C_de_M1_0) then (go1 and req1) else if (G_de_M1_0) then true else memoire_de_gnt1;
   suiv_I_de_M1_0=if (I_de_M1_0) then (not (condition_de_I_de_M1_0_vers_W_de_M1_0_0 or condition_de_I_de_M1_0_vers_G_de_M1_0_1)) else I_de_M1_0,
   suiv_W_de_M1_0=if (I_de_M1_0) then (condition_de_I_de_M1_0_vers_W_de_M1_0_0) else W_de_M1_0,
   suiv_C_de_M1_0=C_de_M1_0,
   suiv_G_de_M1_0=if (I_de_M1_0) then (condition_de_I_de_M1_0_vers_G_de_M1_0_1) else G_de_M1_0,
   suiv_I_de_obs_1=if (I_de_obs_1) then (not (condition_de_I_de_obs_1_vers_E_de_obs_1_0)) else I_de_obs_1,
   suiv_E_de_obs_1=if (I_de_obs_1) then (condition_de_I_de_obs_1_vers_E_de_obs_1_0) else E_de_obs_1,
